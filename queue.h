...
/*
 * queue_t - Queue Node type
 *
 * A queue node is an opaque data structure storing individual nodes on the queue. 
 * Nodes provide access to values on the queue as well as the the next node
 * in the queue, if any.
 */
